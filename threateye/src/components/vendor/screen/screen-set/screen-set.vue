<template>
  <el-container class="screen-set"
      ...
      <el-menu :default-active="defaultIndex"
        ...
        <div class="aside-item">
          <el-menu-item index="0"
                        @click="change_router('0')">基本内容设置</el-menu-item>
        </div>
        <div class="aside-item">
          <i class="tog"
             :class="{'active':defaultIndex == '1','rotate':!rotate1Active}"
             @click="rotateClick();"></i>
          <el-menu-item index="1"
                        @click="change_router('1')"
                        lazy>两侧内容设置</el-menu-item>
          <vuedraggable class="menu-list"
                        v-model="setAsideLists"
                        v-show="defaultIndex == '1' && rotate1Active">
            <transition-group>
              <div class="item"
        ...
        <div class="aside-item">
          <i class="tog"
             :class="{'active':defaultIndex == '2','rotate':!rotate2Active}"
             @click="rotateClick();"></i>
          <el-menu-item index="2"
                        @click="change_router('2')"
                        lazy>顶部指标设置</el-menu-item>
          <vuedraggable class="menu-list"
                        v-model="setTopLists"
                        v-show="defaultIndex == '2' && rotate2Active">
            <transition-group>
              <div class="item"
    ...
    <el-footer class="set-footer">©上海众人智能科技有限公司 版权所有</el-footer>
  </el-container>
</template>
