  ...
  <div id="system_setting_label"
    ...
    <div class="content_box">
      ...
      <div class="custom-top">
        ...
        <el-button class="c_search"
                   @click="search()">搜索</el-button>
        <div class="c_btn_group">
          <el-button class="c_exp"
                     @click="label_handle('','add')">新增标签</el-button>
        </div>
      </div>

      <div class="custom-bom">
        <vuedraggable class="label-lists"
                      v-model="label_data"
                      @end="endCategory()"
                      handle=".tog_edit_seat">
          <transition-group>
            <li class="item undraggable"
                v-for="(item,$idx) in label_data"
              ...
              <div class="toggle_cate">
                ...
                <div class="tog_list">
                  <div class="tog_edit_seat">
                    <img v-if="item.name != '' && item.name != '未分类标签'"
                         class="tog_img tog_img_edit tog_img_edit1"
                         src="@/assets/images/system/set/label_remove.png"
                         title="删除标签类别"
                         @click="category_remove(item);" />
                  </div>
                  <div class="tog_edit_seat">
                    <img v-if="item.name != '' && item.name != '未分类标签'"
                         class="tog_img tog_img_edit"
                         src="@/assets/images/system/set/label_edit.png"
                         title="编辑标签类别"
                         @click="category_edit(item);" />
                  </div>
                  <div class="tog_edit_seat">
                    <img v-if="item.name != '' && item.name != '未分类标签'"
                         class="tog_img tog_img_top"
                         src="@/assets/images/system/set/is_top.png"
                         title="置顶"
                         @click="category_top($idx);" />
                  </div>
                  <div class="tog_edit_seat"
                       style="cursor: move;">
                    <img v-if="item.name != '' && item.name != '未分类标签'"
                         class="tog_img tog_img_drag"
                         src="@/assets/images/system/set/label_drag_h.png"
                         title="拖动" />
                  </div>
                  <a class="tog_arrow"
                    ...
                    <span class="name"
                          v-show="item.status">收起</span>
                    <span class="name"
                          v-show="!item.status">展开</span>
                  </a>
                </div>
              </div>
              <!-- 标签列表 -->
              <div class="toggle_content"
                   v-show="item.status">
                <vuedraggable class="sortable"
                              v-model="item.label"
                              @end="endLabel(item)"
                              handle=".b_img_drag">
                  <transition-group>
                    <li class="sortable_list"
                        v-if="it.label_name != null"
                        :value="it.id"
                        :key="it.id+'_only'"
                        v-for="(it,$ix) in item.label">
                      <button class="btn_label">
                        <div class="b_label">
                          <span class="b_span"
                                :title="it.label_name">{{it.label_name}}</span>
                        </div>
                      </button>
                      <div class="btn_img">
                        <img class="b_img b_img_drag"
                             src="@/assets/images/system/set/label_drag_v.png" />
                        <img class="b_img b_img_edit"
                             title="编辑标签"
                             @click="label_handle(it,'edit');"
                             src="@/assets/images/system/set/label_edit.png" />
                      </div>
                    </li>
                  </transition-group>
                ...
                <button class="btn_label_add"
                        @click="label_handle(item.name,'add');">
                  <img class="ba_img"
                       src="@/assets/images/system/set/label_add.png" />
    ...
    <el-dialog class="add_box pop_box"
      ...
      <div class="title">
        ...
        <span class="title_name"
              v-show="label.types=='add'">新增标签</span>
        <span class="title_name"
              v-show="label.types=='edit'">编辑标签</span>
      </div>
      <div class="content">
        <div class="lab_top">
          <p class="lab_name">标签类别</p>
          <div class="lab_item">
            <img class="lab_item_icon"
                 alt=""
                 src="@/assets/images/system/set/label_triangle_down.png">
            <el-autocomplete :value="label.category_name"
        ...
        <div class="lab_mid">
          <p class="lab_name">标签名称
            <span class="lab_tab">*</span>
          </p>
          <div class="lab_item">
      ...
      <div class="btn_box">
        ...
        <el-button class="cancel_btn"
                   v-if="label.types=='edit'"
